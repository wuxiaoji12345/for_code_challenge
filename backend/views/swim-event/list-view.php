    ...
    <div class="box box-solid bg-aqua">
        <div class="box-body border-radius-none">
            <a  style="color:#FFF;" href="<?=Url::to(['match/update','id'=>$model->id])?>">
                <h4 style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><?=$model->title?></h4>
                <p><span class="fa fa-calendar"></span>&nbsp;&nbsp;&nbsp;起止日期:<?=$model->start_time?>-<?=$model->end_time?></p>
                <p><span class="fa fa-calendar"></span>&nbsp;&nbsp;&nbsp;报名起止日期:<?=$model->reg_start_time?>-<?=$model->reg_end_time?></p>
                <p><span class="fa fa-map-marker"></span>&nbsp;&nbsp;&nbsp;地点:<?=$model->address?></p>
            </a>
        </div>
