...
/**
 * This is the model class for table "swim_event".
 *
 * @property int $id
 ...
 */
class __Event extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['gid', 'userid', 'category_id', 'reg_start_time', 'reg_end_time', 'start_time', 'end_time', 'province_id', 'city_id', 'district_id', 'matchtype', 'weight', 'status', 'publish', 'create_time', 'swim_address_id'], 'integer'],
            [['title'], 'required'],
            [['intro', 'disclaimer'], 'string'],
            [['longitude', 'latitude'], 'number'],
            [['update_time'], 'safe'],
            [['title', 'icon', 'imgurl', 'address', 'tips', 'qrcode', 'logo'], 'string', 'max' => 255],
